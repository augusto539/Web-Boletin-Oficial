// Mismo contenido que frontend/src/data/nichoCannabis.ts, duplicado acá
// porque backend y frontend no comparten build — ver seo.ts, que arma el
// HTML server-rendered de /informes/nicho-cannabis a partir de esto. Si se
// actualiza el informe, hay que actualizar los dos archivos.
//
// sociedadId/personaId: cruzados a mano contra la base (CUIT donde había,
// vínculos reales de la sociedad para los socios) — enlazan a
// /sociedad/:id y /persona/:id en el HTML server-rendered.
