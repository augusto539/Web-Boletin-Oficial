...
// anatomía del nomenclador CLAE". Como el de Mujeres Fundadoras, es un
// estudio de corte transversal sobre toda la base -- acá la variable es la
// clasificación CLAE de ARCA (25.583 asignaciones sobre 11.918 sociedades),
// no un rubro puntual. Sin ENTIDADES/sociedadId: son agregados puros.
//
// Cuatro tablas del informe NO se graficaron a propósito y viven en la
// página como tablas (ver InformeActividadesClae.tsx): la de situación de
// bajas (el valor "0" es el argumento central, un gráfico lo volvería
// invisible), la de clusters (su columna "Núcleo" es texto descriptivo, que
// es lo valioso), la de grupos vacíos (no tiene ninguna variable numérica) y
// la de códigos por nicho (la columna del código más frecuente es narrativa).
