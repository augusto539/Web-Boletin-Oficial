// Contenido del informe "El mapa oculto de las sociedades mendocinas: qué dice
// la teoría de grafos del registro societario". Como los otros estudios de
// corte transversal (mujeresFundadoras, actividadesClae), no recorta la base
// por rubro: mira la FORMA del registro completo modelado como grafo (62.201
// vínculos, 19.563 sociedades, 33.694 personas). Agregados puros, sin
// sociedadId/personaId.
//
// Los tres gráficos que el análisis original ya traía como PNG están
// reconstruidos como componentes nativos con la paleta del proyecto:
// EVOLUCION_* (líneas, dos series + quiebre de 2022), BETWEENNESS_TOP10
// (barras horizontales con profesión como segunda línea) y HOLDING_* (grafo
// relacional del k-core). El ranking de betweenness del gráfico original trae
// 10 personas; la tabla del documento fuente solo listaba 7 -- se usan las 10.
