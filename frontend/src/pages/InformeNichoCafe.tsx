...
import { DEPARTAMENTOS_CAFE, EVOLUCION_ANUAL, PERFIL_SOCIETARIO_DONA } from "../data/nichoCafe";
...
export default function InformeNichoCafe() {
  ...
  useEffect(() => {
    obtenerEntidadesNicho("cafe").then(setDatos);
  }, []);
  ...
  async function descargar() {
    ...
    try {
      ...
      await exportarNichoCafePDF(datos.entidades);
